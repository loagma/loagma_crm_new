      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          ...
          child: Padding(
            ...
            child: Text('Tap to assign ${_level.childLabel.toLowerCase()}s',
                  ...
                  children: [
                    ...
                    if (!has)
                      Row(children: [
                        ...
                        Text('No ${level.childLabel.toLowerCase()}s assigned',
                      ...
                      Row(children: [
                        ...
                        const SizedBox(width: 4),
                        Text('${assignedChildren.length} ${level.childLabelCount(assignedChildren.length).toLowerCase()} assigned',
